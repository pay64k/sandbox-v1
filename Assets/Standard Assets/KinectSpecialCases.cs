...
namespace Windows.KinectV2
{
    ...
    public sealed partial class AudioBeamSubFrame
    {
        ...
        public Windows.KinectV2.KinectBuffer LockAudioBuffer()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("AudioBeamSubFrame");
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.KinectBuffer>(objectPointer, n => new Windows.KinectV2.KinectBuffer(n));
        }
    }

    public sealed partial class AudioBeamFrame
    {
        private Windows.KinectV2.AudioBeamSubFrame[] _subFrames = null;
        ...
        public RootSystem.Collections.Generic.IList<Windows.KinectV2.AudioBeamSubFrame> SubFrames
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                if (_subFrames == null)
                {
                    ...
                    _subFrames = new Windows.KinectV2.AudioBeamSubFrame[collectionSize];
                    ...
                    for (int i = 0; i < collectionSize; i++)
                    {
                        ...
                        var obj = Helper.NativeObjectCache.GetObject<Windows.KinectV2.AudioBeamSubFrame>(outCollection[i]);
                        if (obj == null)
                        {
                            obj = new Windows.KinectV2.AudioBeamSubFrame(outCollection[i]);
                            Helper.NativeObjectCache.AddObject<Windows.KinectV2.AudioBeamSubFrame>(outCollection[i], obj);
                        }
    ...
    public sealed partial class BodyFrame
    {
        ...
        public void GetAndRefreshBodyData(RootSystem.Collections.Generic.IList<Windows.KinectV2.Body> bodies)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
    ...
    public sealed partial class Body
    {
        ...
        public Windows.KinectV2.PointF Lean
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                var obj = (Windows.KinectV2.PointF)RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(objectPointer, typeof(Windows.KinectV2.PointF));
    ...
    public sealed partial class ColorFrame
    {
        ...
        [RootSystem.Runtime.InteropServices.DllImport(
            ...
            CallingConvention = RootSystem.Runtime.InteropServices.CallingConvention.Cdecl,
            SetLastError = true)]
        private static extern void Windows_Kinect_ColorFrame_CopyConvertedFrameDataToIntPtr(RootSystem.IntPtr pNative, IntPtr frameData, uint frameDataSize, Windows.KinectV2.ColorImageFormat colorFormat);
        public void CopyConvertedFrameDataToIntPtr(RootSystem.IntPtr frameData, uint size, Windows.KinectV2.ColorImageFormat colorFormat)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("ColorFrame");
        ...
        public Windows.KinectV2.KinectBuffer LockRawImageBuffer()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("ColorFrame");
    ...
    public sealed partial class DepthFrame
    {
        ...
        public Windows.KinectV2.KinectBuffer LockImageBuffer()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("DepthFrame");
    ...
    public sealed partial class CoordinateMapper
    {
        ...
        public Windows.KinectV2.CameraIntrinsics GetDepthCameraIntrinsics()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
            ...
            var obj = (Windows.KinectV2.CameraIntrinsics)RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(objectPointer, typeof(Windows.KinectV2.CameraIntrinsics));
            RootSystem.Runtime.InteropServices.Marshal.FreeHGlobal(objectPointer);
            return obj;
        }
        ...
        public Windows.KinectV2.PointF[] GetDepthFrameToCameraSpaceTable()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
