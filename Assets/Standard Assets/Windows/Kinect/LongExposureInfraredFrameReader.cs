...
namespace Windows.KinectV2
{
...

    {
        ...
        {
            List<RootSystem.EventHandler<Windows.KinectV2.LongExposureInfraredFrameArrivedEventArgs>> callbackList = null;
            ...
            lock(callbackList)
            {
                ...
                var args = new Windows.KinectV2.LongExposureInfraredFrameArrivedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.KinectV2.LongExposureInfraredFrameArrivedEventArgs> FrameArrived
        {
            add
            {
        ...
        public Windows.KinectV2.LongExposureInfraredFrame AcquireLatestFrame()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("LongExposureInfraredFrameReader");
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.LongExposureInfraredFrame>(objectPointer, n => new Windows.KinectV2.LongExposureInfraredFrame(n));
        }
