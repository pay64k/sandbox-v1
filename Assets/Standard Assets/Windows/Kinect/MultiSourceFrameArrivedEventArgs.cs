...
namespace Windows.KinectV2
{
...

    {
        ...
        public  Windows.KinectV2.MultiSourceFrameReference FrameReference
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.MultiSourceFrameReference>(objectPointer, n => new Windows.KinectV2.MultiSourceFrameReference(n));
            }
        }
