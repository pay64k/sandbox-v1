...
namespace Windows.KinectV2
{
...

    {
        ...
        public  RootSystem.Collections.Generic.IList<Windows.KinectV2.AudioBeam> AudioBeams
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                var managedCollection = new Windows.KinectV2.AudioBeam[outCollectionSize];
                ...
                for(int i=0;i<outCollectionSize;i++)
                {
                    ...
                    var obj = Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.AudioBeam>(outCollection[i], n => new Windows.KinectV2.AudioBeam(n));
        ...
        public  Windows.KinectV2.KinectSensor KinectSensor
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern Windows.KinectV2.KinectAudioCalibrationState Windows_Kinect_AudioSource_get_AudioCalibrationState(RootSystem.IntPtr pNative);
        public  Windows.KinectV2.KinectAudioCalibrationState AudioCalibrationState
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        private static Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.KinectV2.FrameCapturedEventArgs>>> Windows_Kinect_FrameCapturedEventArgs_Delegate_callbacks = new Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.KinectV2.FrameCapturedEventArgs>>>();
        ...
        {
            List<RootSystem.EventHandler<Windows.KinectV2.FrameCapturedEventArgs>> callbackList = null;
            ...
            lock(callbackList)
            {
                ...
                var args = new Windows.KinectV2.FrameCapturedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.KinectV2.FrameCapturedEventArgs> FrameCaptured
        {
            add
            {
        ...
        public Windows.KinectV2.AudioBeamFrameReader OpenReader()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("AudioSource");
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.AudioBeamFrameReader>(objectPointer, n => new Windows.KinectV2.AudioBeamFrameReader(n));
        }
