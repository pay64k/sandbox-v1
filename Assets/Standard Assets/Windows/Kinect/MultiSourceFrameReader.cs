...
namespace Windows.KinectV2
{
...

    {
        ...
        // Public Properties
        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern Windows.KinectV2.FrameSourceTypes Windows_Kinect_MultiSourceFrameReader_get_FrameSourceTypes(RootSystem.IntPtr pNative);
        public  Windows.KinectV2.FrameSourceTypes FrameSourceTypes
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        private static Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.KinectV2.MultiSourceFrameArrivedEventArgs>>> Windows_Kinect_MultiSourceFrameArrivedEventArgs_Delegate_callbacks = new Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.KinectV2.MultiSourceFrameArrivedEventArgs>>>();
        ...
        {
            List<RootSystem.EventHandler<Windows.KinectV2.MultiSourceFrameArrivedEventArgs>> callbackList = null;
            ...
            lock(callbackList)
            {
                ...
                var args = new Windows.KinectV2.MultiSourceFrameArrivedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.KinectV2.MultiSourceFrameArrivedEventArgs> MultiSourceFrameArrived
        {
            add
            {
        ...
        public Windows.KinectV2.MultiSourceFrame AcquireLatestFrame()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("MultiSourceFrameReader");
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.MultiSourceFrame>(objectPointer, n => new Windows.KinectV2.MultiSourceFrame(n));
        }
