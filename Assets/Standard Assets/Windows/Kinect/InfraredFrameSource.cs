...
namespace Windows.KinectV2
{
...

    {
        ...
        public Windows.KinectV2.InfraredFrameReader OpenReader()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("InfraredFrameSource");
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.InfraredFrameReader>(objectPointer, n => new Windows.KinectV2.InfraredFrameReader(n));
        }
