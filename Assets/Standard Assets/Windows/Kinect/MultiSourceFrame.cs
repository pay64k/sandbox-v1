...
namespace Windows.KinectV2
{
...

    {
        ...
        public  Windows.KinectV2.BodyFrameReference BodyFrameReference
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.BodyFrameReference>(objectPointer, n => new Windows.KinectV2.BodyFrameReference(n));
            }
        }
        ...
        public  Windows.KinectV2.BodyIndexFrameReference BodyIndexFrameReference
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.BodyIndexFrameReference>(objectPointer, n => new Windows.KinectV2.BodyIndexFrameReference(n));
            }
        }
        ...
        public  Windows.KinectV2.ColorFrameReference ColorFrameReference
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.ColorFrameReference>(objectPointer, n => new Windows.KinectV2.ColorFrameReference(n));
            }
        }
        ...
        public  Windows.KinectV2.DepthFrameReference DepthFrameReference
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.DepthFrameReference>(objectPointer, n => new Windows.KinectV2.DepthFrameReference(n));
            }
        }
        ...
        public  Windows.KinectV2.InfraredFrameReference InfraredFrameReference
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.InfraredFrameReference>(objectPointer, n => new Windows.KinectV2.InfraredFrameReference(n));
            }
        }
        ...
        public  Windows.KinectV2.LongExposureInfraredFrameReference LongExposureInfraredFrameReference
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.LongExposureInfraredFrameReference>(objectPointer, n => new Windows.KinectV2.LongExposureInfraredFrameReference(n));
            }
        }
