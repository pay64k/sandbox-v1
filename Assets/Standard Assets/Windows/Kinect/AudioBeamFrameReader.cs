...
namespace Windows.KinectV2
{
...

    {
        ...
        private static Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.KinectV2.AudioBeamFrameArrivedEventArgs>>> Windows_Kinect_AudioBeamFrameArrivedEventArgs_Delegate_callbacks = new Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.KinectV2.AudioBeamFrameArrivedEventArgs>>>();
        ...
        {
            List<RootSystem.EventHandler<Windows.KinectV2.AudioBeamFrameArrivedEventArgs>> callbackList = null;
            ...
            lock(callbackList)
            {
                ...
                var args = new Windows.KinectV2.AudioBeamFrameArrivedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.KinectV2.AudioBeamFrameArrivedEventArgs> FrameArrived
        {
            add
            {
        ...
        public RootSystem.Collections.Generic.IList<Windows.KinectV2.AudioBeamFrame> AcquireLatestBeamFrames()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("AudioBeamFrameReader");
            ...
            var managedCollection = new Windows.KinectV2.AudioBeamFrame[outCollectionSize];
            ...
            for(int i=0;i<outCollectionSize;i++)
            {
                ...
                var obj = Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.AudioBeamFrame>(outCollection[i], n => new Windows.KinectV2.AudioBeamFrame(n));
