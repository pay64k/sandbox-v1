...
namespace Windows.KinectV2
{
...

    {
        ...
        public  Windows.KinectV2.AudioBeamFrameReference FrameReference
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.AudioBeamFrameReference>(objectPointer, n => new Windows.KinectV2.AudioBeamFrameReference(n));
            }
        }
