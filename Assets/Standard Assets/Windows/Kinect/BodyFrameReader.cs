...
namespace Windows.KinectV2
{
...

    {
        ...
        private static Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.KinectV2.BodyFrameArrivedEventArgs>>> Windows_Kinect_BodyFrameArrivedEventArgs_Delegate_callbacks = new Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.KinectV2.BodyFrameArrivedEventArgs>>>();
        ...
        {
            List<RootSystem.EventHandler<Windows.KinectV2.BodyFrameArrivedEventArgs>> callbackList = null;
            ...
            lock(callbackList)
            {
                ...
                var args = new Windows.KinectV2.BodyFrameArrivedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.KinectV2.BodyFrameArrivedEventArgs> FrameArrived
        {
            add
            {
        ...
        public Windows.KinectV2.BodyFrame AcquireLatestFrame()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("BodyFrameReader");
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.BodyFrame>(objectPointer, n => new Windows.KinectV2.BodyFrame(n));
        }
