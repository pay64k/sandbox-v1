...
namespace Windows.KinectV2
{
...

    {
        ...
        public Windows.KinectV2.BodyFrameReader OpenReader()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("BodyFrameSource");
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.BodyFrameReader>(objectPointer, n => new Windows.KinectV2.BodyFrameReader(n));
        }
