...
namespace Windows.KinectV2
{
...

    {
        ...
        private static Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.KinectV2.ColorFrameArrivedEventArgs>>> Windows_Kinect_ColorFrameArrivedEventArgs_Delegate_callbacks = new Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.KinectV2.ColorFrameArrivedEventArgs>>>();
        ...
        {
            List<RootSystem.EventHandler<Windows.KinectV2.ColorFrameArrivedEventArgs>> callbackList = null;
            ...
            lock(callbackList)
            {
                ...
                var args = new Windows.KinectV2.ColorFrameArrivedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.KinectV2.ColorFrameArrivedEventArgs> FrameArrived
        {
            add
            {
        ...
        public Windows.KinectV2.ColorFrame AcquireLatestFrame()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("ColorFrameReader");
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.ColorFrame>(objectPointer, n => new Windows.KinectV2.ColorFrame(n));
        }
