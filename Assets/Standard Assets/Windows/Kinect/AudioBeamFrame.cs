...
namespace Windows.KinectV2
{
...

    {
        ...
        public  Windows.KinectV2.AudioBeam AudioBeam
        {
            get
            {
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.AudioBeam>(objectPointer, n => new Windows.KinectV2.AudioBeam(n));
            }
        }
