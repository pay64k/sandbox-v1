...
namespace Windows.KinectV2
{
...

    {
        ...
        {
            List<RootSystem.EventHandler<Windows.KinectV2.InfraredFrameArrivedEventArgs>> callbackList = null;
            ...
            lock(callbackList)
            {
                ...
                var args = new Windows.KinectV2.InfraredFrameArrivedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.KinectV2.InfraredFrameArrivedEventArgs> FrameArrived
        {
            add
            {
        ...
        public Windows.KinectV2.InfraredFrame AcquireLatestFrame()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("InfraredFrameReader");
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.InfraredFrame>(objectPointer, n => new Windows.KinectV2.InfraredFrame(n));
        }
