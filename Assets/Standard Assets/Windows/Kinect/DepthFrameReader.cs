...
namespace Windows.KinectV2
{
...

    {
        ...
        private static Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.KinectV2.DepthFrameArrivedEventArgs>>> Windows_Kinect_DepthFrameArrivedEventArgs_Delegate_callbacks = new Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.KinectV2.DepthFrameArrivedEventArgs>>>();
        ...
        {
            List<RootSystem.EventHandler<Windows.KinectV2.DepthFrameArrivedEventArgs>> callbackList = null;
            ...
            lock(callbackList)
            {
                ...
                var args = new Windows.KinectV2.DepthFrameArrivedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.KinectV2.DepthFrameArrivedEventArgs> FrameArrived
        {
            add
            {
        ...
        public Windows.KinectV2.DepthFrame AcquireLatestFrame()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("DepthFrameReader");
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.DepthFrame>(objectPointer, n => new Windows.KinectV2.DepthFrame(n));
        }
