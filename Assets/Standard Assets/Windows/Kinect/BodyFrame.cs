...
namespace Windows.KinectV2
{
...

    {
        ...
        public  Windows.KinectV2.Vector4 FloorClipPlane
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                Helper.ExceptionHelper.CheckLastError();
                var obj = (Windows.KinectV2.Vector4)RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(objectPointer, typeof(Windows.KinectV2.Vector4));
                Windows.KinectV2.KinectUnityAddinUtils.FreeMemory(objectPointer);
                return obj;
            }
        }
