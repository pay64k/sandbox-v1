...
namespace Windows.KinectV2
{
...

    {
        ...
        public Windows.KinectV2.LongExposureInfraredFrameReader OpenReader()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("LongExposureInfraredFrameSource");
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.LongExposureInfraredFrameReader>(objectPointer, n => new Windows.KinectV2.LongExposureInfraredFrameReader(n));
        }
