...
namespace Windows.KinectV2
{
...

    {
        ...
        private static Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.KinectV2.CoordinateMappingChangedEventArgs>>> Windows_Kinect_CoordinateMappingChangedEventArgs_Delegate_callbacks = new Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.KinectV2.CoordinateMappingChangedEventArgs>>>();
        ...
        {
            List<RootSystem.EventHandler<Windows.KinectV2.CoordinateMappingChangedEventArgs>> callbackList = null;
            ...
            lock(callbackList)
            {
                ...
                var args = new Windows.KinectV2.CoordinateMappingChangedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.KinectV2.CoordinateMappingChangedEventArgs> CoordinateMappingChanged
        {
            add
            {
        ...
        // Public Methods
        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern RootSystem.IntPtr Windows_Kinect_CoordinateMapper_MapCameraPointToDepthSpace(RootSystem.IntPtr pNative, Windows.KinectV2.CameraSpacePoint cameraPoint);
        public Windows.KinectV2.DepthSpacePoint MapCameraPointToDepthSpace(Windows.KinectV2.CameraSpacePoint cameraPoint)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
            ...
            var obj = (Windows.KinectV2.DepthSpacePoint)RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(objectPointer, typeof(Windows.KinectV2.DepthSpacePoint));
            RootSystem.Runtime.InteropServices.Marshal.FreeHGlobal(objectPointer);
            return obj;
        }

        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern RootSystem.IntPtr Windows_Kinect_CoordinateMapper_MapCameraPointToColorSpace(RootSystem.IntPtr pNative, Windows.KinectV2.CameraSpacePoint cameraPoint);
        public Windows.KinectV2.ColorSpacePoint MapCameraPointToColorSpace(Windows.KinectV2.CameraSpacePoint cameraPoint)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
            ...
            Helper.ExceptionHelper.CheckLastError();
            var obj = (Windows.KinectV2.ColorSpacePoint)RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(objectPointer, typeof(Windows.KinectV2.ColorSpacePoint));
            RootSystem.Runtime.InteropServices.Marshal.FreeHGlobal(objectPointer);
            return obj;
        }

        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern RootSystem.IntPtr Windows_Kinect_CoordinateMapper_MapDepthPointToCameraSpace(RootSystem.IntPtr pNative, Windows.KinectV2.DepthSpacePoint depthPoint, ushort depth);
        public Windows.KinectV2.CameraSpacePoint MapDepthPointToCameraSpace(Windows.KinectV2.DepthSpacePoint depthPoint, ushort depth)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
            ...
            Helper.ExceptionHelper.CheckLastError();
            var obj = (Windows.KinectV2.CameraSpacePoint)RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(objectPointer, typeof(Windows.KinectV2.CameraSpacePoint));
            RootSystem.Runtime.InteropServices.Marshal.FreeHGlobal(objectPointer);
            return obj;
        }

        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern RootSystem.IntPtr Windows_Kinect_CoordinateMapper_MapDepthPointToColorSpace(RootSystem.IntPtr pNative, Windows.KinectV2.DepthSpacePoint depthPoint, ushort depth);
        public Windows.KinectV2.ColorSpacePoint MapDepthPointToColorSpace(Windows.KinectV2.DepthSpacePoint depthPoint, ushort depth)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapCameraPointsToDepthSpace(Windows.KinectV2.CameraSpacePoint[] cameraPoints, Windows.KinectV2.DepthSpacePoint[] depthPoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapCameraPointsToColorSpace(Windows.KinectV2.CameraSpacePoint[] cameraPoints, Windows.KinectV2.ColorSpacePoint[] colorPoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapDepthPointsToCameraSpace(Windows.KinectV2.DepthSpacePoint[] depthPoints, ushort[] depths, Windows.KinectV2.CameraSpacePoint[] cameraPoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapDepthPointsToColorSpace(Windows.KinectV2.DepthSpacePoint[] depthPoints, ushort[] depths, Windows.KinectV2.ColorSpacePoint[] colorPoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapDepthFrameToCameraSpace(ushort[] depthFrameData, Windows.KinectV2.CameraSpacePoint[] cameraSpacePoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapDepthFrameToColorSpace(ushort[] depthFrameData, Windows.KinectV2.ColorSpacePoint[] colorSpacePoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapColorFrameToDepthSpace(ushort[] depthFrameData, Windows.KinectV2.DepthSpacePoint[] depthSpacePoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapColorFrameToCameraSpace(ushort[] depthFrameData, Windows.KinectV2.CameraSpacePoint[] cameraSpacePoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
