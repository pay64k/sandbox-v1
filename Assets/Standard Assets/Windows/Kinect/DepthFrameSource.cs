...
namespace Windows.KinectV2
{
...

    {
        ...
        public Windows.KinectV2.DepthFrameReader OpenReader()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("DepthFrameSource");
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.DepthFrameReader>(objectPointer, n => new Windows.KinectV2.DepthFrameReader(n));
        }
