...
namespace Windows.KinectV2
{
...

    {
        ...
        // Public Properties
        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern Windows.KinectV2.AudioBeamMode Windows_Kinect_AudioBeamSubFrame_get_AudioBeamMode(RootSystem.IntPtr pNative);
        public  Windows.KinectV2.AudioBeamMode AudioBeamMode
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        public  RootSystem.Collections.Generic.IList<Windows.KinectV2.AudioBodyCorrelation> AudioBodyCorrelations
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                var managedCollection = new Windows.KinectV2.AudioBodyCorrelation[outCollectionSize];
                ...
                for(int i=0;i<outCollectionSize;i++)
                {
                    ...
                    var obj = Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.AudioBodyCorrelation>(outCollection[i], n => new Windows.KinectV2.AudioBodyCorrelation(n));
