...
namespace Windows.KinectV2
{
...

    {
        ...
        public  Windows.KinectV2.FrameDescription FrameDescription
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.FrameDescription>(objectPointer, n => new Windows.KinectV2.FrameDescription(n));
            }
        }
        ...
        public Windows.KinectV2.ColorFrameReader OpenReader()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("ColorFrameSource");
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.KinectV2.ColorFrameReader>(objectPointer, n => new Windows.KinectV2.ColorFrameReader(n));
        }

        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern RootSystem.IntPtr Windows_Kinect_ColorFrameSource_CreateFrameDescription(RootSystem.IntPtr pNative, Windows.KinectV2.ColorImageFormat format);
        public Windows.KinectV2.FrameDescription CreateFrameDescription(Windows.KinectV2.ColorImageFormat format)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("ColorFrameSource");
